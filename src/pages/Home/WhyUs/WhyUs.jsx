  ...
  return (
    <div className="mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card w-full shadow-xl hover:shadow-[#90c641e6] hover:shadow-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-700">
